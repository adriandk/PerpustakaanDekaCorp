    ...
    <nav class="navbar navbar-expand-sm bg-dark">
      ...
      <div class="container">
            <table class="table mt-5">
                <tr>
                    <td>
                        <a  href="addpenerbit.php" class="btn btn-primary">Add</a>
                    </td>
                ...
                <tr class="thead-dark">
                    ...
                    if (isset($_POST['searchbtn'])) {
                        ...
                        if (empty($search)) {
                            ...
                            $sql = "SELECT * from penerbit where nama LIKE '%$search%'";   
                        }
                    }
                    ...
                    while ($row = $query->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo "<td scope='col' style='width: 20%;'>".$row['nama']."</td>";
                        echo "<td scope='col' style='width: 20%;'>".$row['alamat']."</td>";
                        echo "<td scope='col' style='width: 20%;'>".$row['phone']."</td>";
                        echo "<td scope='col' style='width: 20%;'>".$row['email']."</td>";
                        echo "<td scope='col' style='text-align: center;'>
                        <a href =\"editdatapenerbit.php?id=$row[idPenerbit]\"><img src='assets/images/edit.png' style='width: 30px; height: 30px;'></a> &nbsp;
                        <a href =\"deletepenerbit.php?id=$row[idPenerbit]\" onClick =\"return confirm ('Are You Sure?')\"><img src='assets/images/hapus.png' style='width: 30px; height: 30px;'></a></td>";
                    }
